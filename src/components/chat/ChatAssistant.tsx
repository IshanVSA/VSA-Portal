      ...
      <AnimatePresence>
        {!open && (
          <motion.button
            ...
            className="fixed bottom-20 right-4 sm:bottom-6 sm:right-6 z-50 h-12 w-12 sm:h-14 sm:w-14 rounded-full bg-primary text-primary-foreground shadow-lg hover:shadow-xl flex items-center justify-center transition-shadow hover:scale-105 active:scale-95"
          >
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-4 right-4 left-4 sm:left-auto sm:bottom-6 sm:right-6 z-50 w-auto sm:w-[380px] h-[70vh] sm:h-[520px] max-h-[85vh] bg-card border border-border rounded-2xl shadow-2xl flex flex-col overflow-hidden"
          >
            {/* Header */}
