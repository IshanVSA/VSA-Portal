...
.mh-left{position:relative;z-index:1;min-width:0}
.mh-right{position:relative;z-index:1;padding-top:4px}
.mh-logo{height:30px;width:auto;display:block;object-fit:contain}
